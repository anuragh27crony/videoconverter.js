...
emconfigure ./configure --cc="emcc" --prefix=$(pwd)/../dist --enable-cross-compile --target-os=none --arch=x86_32 --cpu=generic \
    ...
    --enable-demuxer=concat  --enable-protocol=file --enable-protocol=http --enable-filter=aresample  --enable-filter=scale  --enable-filter=crop  --enable-filter=overlay  --disable-bzlib  --disable-iconv  \
    ...
    --enable-muxer=mp4  --enable-muxer=mp3 --enable-muxer=image2 --enable-muxer=null  --enable-gpl  --enable-libmp3lame --enable-libvpx --enable-libx264 --disable-hwaccels --disable-parsers --disable-bsfs --disable-debug --disable-protocols \
